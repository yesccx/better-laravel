 ...
 * @method QueryBuilder|EloquentBuilder|static|$this whereInDay(mixed $field) 查询是否为某日
 ...
 * @method QueryBuilder|EloquentBuilder|static|$this whereInMonth(mixed $field) 查询是否为某月
 * @method QueryBuilder|EloquentBuilder|static|$this whereThisYear(mixed $field) 查询是否为本年
 * @method QueryBuilder|EloquentBuilder|static|$this whereInYear(mixed $field) 查询是否为某年
